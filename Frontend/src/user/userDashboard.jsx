...
import { FaMale, FaFemale, FaMoon, FaSun, FaBars } from "react-icons/fa"; // Added FaBars
import api from "../api";
...
export default function UserDashboard() {
  ...
  // Get unique months from both hires & leavers
        ...
        <div className="flex h-screen bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800">
          ...
          */}
          <main className="flex-1 p-4 sm:p-6 overflow-auto text-gray-800 dark:text-gray-200">
            ...
            {/* --- RESPONSIVENESS FIX ---
              - Added `sm:grid-cols-2 md:grid-cols-3`
            */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-6">
              ...
              {/* KPI: Payroll */}
              <div className="bg-purple-500 text-white p-4 rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-transform lg:col-span-1 md:col-span-3 sm:col-span-2">
            ...
            <ErrorBoundary>
              ...
              */}
              ...
              {/* Training Analytics */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                {/* Bar Chart → Trainings by Department */}
                <div className="bg-white shadow-md hover:shadow-xl transition rounded-2xl p-6 dark:bg-gray-800">
                  <h3 className="font-semibold mb-6 text-gray-700 dark:text-gray-300">
